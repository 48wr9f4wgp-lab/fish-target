...
test('generated HTML, result header, assets, and SW share one build version',()=>{
  ...
  assert.doesNotMatch(html,/__(?:BUILD_VERSION|BUILD_ID|CACHE_BUILD_ID|FIELD_LIVE_STATE|SHELL_MANIFEST)__/);
  assert.doesNotMatch(worker,/__(?:BUILD_VERSION|BUILD_ID|CACHE_BUILD_ID|FIELD_LIVE_STATE|SHELL_MANIFEST)__/);
});
