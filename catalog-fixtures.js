(()=>{
  ...
  const product=(maker,category,series,generation,model,specs)=>({maker,category,series,generation,model,display_name:`${series} ${model}`,status:'current',specs,source:source()});
