...
export function loadRightsQueue(){
  ...
  return Object.freeze(missing.map((species_name,index)=>Object.freeze({
    queue_id:`fish-rights-${String(index+1).padStart(2,'0')}`,
    species_name,
...
if(process.argv[1]&&new URL(`file://${process.argv[1]}`).href===import.meta.url){
  ...
  console.log(JSON.stringify({count:queue.length,species:queue.map(x=>x.species_name)},null,2));
}
